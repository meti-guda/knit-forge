          ...
          <main className="min-h-screen bg-gray-50 p-6">
               ...
               <div className="max-w-xl mx-auto bg-white rounded-2xl shadow p-5">
                    <p className="text-sm text-gray-600 mb-3">
                         This is where all your patterns will live. For now, there is one sample pattern.
                    </p>
                    <ul className="space-y-2">
                         <li>
                              <Link
                                   href="/patterns/sample"
                                   className="block px-4 py-3 rounded-xl border hover:bg-rose-50 hover:border-rose-200"
                              >
